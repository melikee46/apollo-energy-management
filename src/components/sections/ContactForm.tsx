...
export function ContactForm({ locale = "en" }: { locale?: Locale }) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
      ...
      <Field label={german ? "Wie können wir helfen?" : "How can we help?"} error={errors.message?.message}><textarea {...register("message")} rows={7} className="field min-h-[180px] resize-y" /></Field>
