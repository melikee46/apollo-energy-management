    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <div style={{ color: "#D4FF6B", fontSize: 28, fontWeight: 700, letterSpacing: "0.18em" }}>
            APOLLO GREEN SOLUTIONS
          </div>
          <div style={{ fontSize: 76, fontWeight: 900, lineHeight: 1.02, maxWidth: 720 }}>
            Make every watt count.
          </div>
          <div style={{ color: "#E8F5B8", fontSize: 28 }}>
            Industrial energy intelligence
          </div>
        </div>
        <div style={{ color: "#D4FF6B", fontSize: 160, fontWeight: 900 }}>*</div>
      </div>
    ),
    { ...size },
  );
